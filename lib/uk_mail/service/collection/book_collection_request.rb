      ...
      class BookCollectionRequest < RequestBase
        ...
        def build
          @validated_parameters = build_group(
            ...
            {  name: 'Earliest time',             value: format_date(params[:earliest_time])              },
            {  name: 'Latest time',               value: format_date(params[:latest_time])                },
            {  name: 'Requested collection date', value: format_date(params[:requested_collection_date])  },
